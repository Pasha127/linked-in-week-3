...
const Analytics = () => {
      ...
      return (
            <Card className="mt-4"style={{ width: '46rem', borderRadius: "12px", height: "200px" }}>
                 <Row>
                 ...
                 <Row>
                  ...
                  <Row className="px-4 mt-3">
                        <Col md={4}>
                              <Col>
                                    <i class="bi bi-people-fill" style={{fontSize: "25px"}}></i>
                        ...
                        <Col md={4}>
                        <Col>
                                    <i class="bi bi-bar-chart-line-fill" style={{fontSize: "25px"}}></i>
